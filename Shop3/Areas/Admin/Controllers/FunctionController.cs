    ...
    public class FunctionController : BaseController
    {
        ...
        public async Task<IActionResult> GetAll(int page, int pageSize)
        {
            ...
            foreach (var function in rootFunctions)
            {
                ...
                GetByParentId(model.ToList(), function, items); // lấy ra  con
            }
        ...
        {   // dùng đệ quy đặt tất cả con dưới cha
            var functionsEntities = allFunctions as FunctionViewModel[] ?? allFunctions.ToArray(); // tổng số funtion
